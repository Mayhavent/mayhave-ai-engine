      ...
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-16 space-y-4 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground">
            Everything you need to know about working with Mayhave
          </p>
        </div>
        ...
        <Accordion type="single" collapsible className="space-y-4">
          {faqs.map((faq, index) => (
            <AccordionItem 
              key={index} 
              value={`item-${index}`}
              className="bg-card/50 backdrop-blur-sm border border-primary/10 rounded-lg px-6 animate-fade-in-up"
