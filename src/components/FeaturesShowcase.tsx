...
function MockWindow({ dark = false }) {
  return (
    <div
      className={`relative rounded-2xl border p-5 shadow-2xl transition ${dark ? "border-white/10 bg-gradient-to-b from-white/5 to-transparent" : "border-white/10 bg-white/5"}`}
    >
      {/* glow ring */}
